...
var wsDeabute = {
    ...
    init: function(onConnection){
        ...
        wsDeabute.instance.onopen = function(event){
            ...
            wsDeabute.send({type: 'connected', oid: localStorage.oid, lastMatches: rtc.lastMatches});
...
var deabute = {
    ...
    login: function(){
        ...
        if(username && password){
            ...
            wsDeabute.send({type: 'login', username: username, password: password});
    ...
    signup: function(){
        ...
        if(username && password){
            ...
            wsDeabute.send({type: 'signup', username: username, password: password});
        } else {console.log('missing shit');}
    }
};
