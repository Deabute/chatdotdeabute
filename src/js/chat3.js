...
var channel = {
    ...
    visitor: function (req) {
        ...
        else { app.description.innerHTML = channel.name + ' is ' + req.status; }
    },
    status: function (req) {
        if (req.exist) {
            if (req.multi) {
        ...
        } else { app.description.innerHTML = 'Sorry, not much is here. Aside from this text'; }
    }
};
...
var app = {
    ...
    outsideService: function () {
        ...
        app.description.innerHTML = 'Please wait till our next scheduled matching to participate';
    },
...
var setup = { // methods that are interconnected and intertwined with dependencies
    ws: function () {
...
persistence.init(function onLocalRead(capable) {
    ...
    } else { app.description.innerHTML = 'Incompatible browser'; }
});
